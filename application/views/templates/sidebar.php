  ...
  <ul class="navbar-nav flex-column">
    ...
    <!-- Nav item -->
    <li class="nav-item">
      <a class="nav-link dropdown-toggle <?php echo ($current_page == 'users') ? 'active' : ''; ?>" data-bs-toggle="dropdown" aria-expanded="false">
        <span class="nav-icon">
      ...
      <ul class="dropdown-menu flex-column">
        <li class="nav-item">
          <a class='nav-link <?php echo ($current_page == 'users' && $current_method == 'create') ? 'active' : ''; ?>' href="<?php echo base_url('users/create') ?>">Add New User</a>
        </li>
        <li class="nav-item">
          <a class='nav-link <?php echo ($current_page == 'users' && ($current_method == '' || $current_method == 'index')) ? 'active' : ''; ?>' href="<?php echo base_url('users') ?>">Manage Users</a>
        </li>
      </ul>
    </li>
    ...
    <!-- Nav item -->
    <li class="nav-item">
      <a class='nav-link <?php echo ($current_page == 'system-settings' || $current_page == 'settings') ? 'active' : ''; ?>' href='#system-settings'>
        <span class="nav-icon">
