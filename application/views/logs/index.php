        ...
        <div class="custom-container" style="min-height: calc(100vh - 120px);">
            ...
            <!-- Welcome Section -->
            <div class="mb-6">
              <h4 class="mb-2 d-flex align-items-center">Activity Logs</h4>
                ...
                <div class="card card-lg">
                  <div class="card-header border-bottom-0">
                     <div class="row g-4">
                        <div class="col-lg-3">
                          ...
                          <input type="search" class="form-control" id="searchInput" placeholder="Search logs...">
                        </div>
                        <div class="col-lg-3">
                      ...
                      <div class="row g-4 mt-1 mb-1">
                        ...
                        <div class="col-lg-3 d-flex justify-content-end align-items-end gap-2">
                          ...
                          <a href="<?php echo base_url('logs/archived'); ?>" class="btn btn-outline-secondary">
                  ...
                  <div class="card-footer border-top border-dashed">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                      <p class="mb-0" id="entriesInfo">0 entries found</p>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p class="mb-0">Are you sure you want to archive <strong id="archiveCount">0</strong> log(s)?</p>
              <p class="text-muted small mt-2 mb-0">Archived logs can be restored from the archived logs page.</p>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadLogs(page = 1) {
        ...
        fetch('<?php echo base_url(); ?>logs/fetchLogs?' + params.toString())
            .then(response => response.json())
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('entriesInfo').textContent = data.range;
    ...
    document.getElementById('archiveAction').addEventListener('click', function(e) {
        ...
        if (checked.length === 0) {
            showAlert('Please select at least one log to archive', 'danger');
            return;
        }
    ...
    document.getElementById('confirmArchiveBtn').addEventListener('click', function() {
        ...
        fetch('<?php echo base_url(); ?>logs/archiveLogs', {
            method: 'POST',
