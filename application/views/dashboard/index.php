              ...
              <div class="card card-lg">
                <div class="card-header border-bottom-0">
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-info-subtle text-info-emphasis"><?php echo $dashboard_stats['upcoming_count']; ?> Upcoming</span>
                  </div>
                </div>
                <div class="card-body">
                  <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="d-flex gap-3 p-3 border rounded">
                        <div class="icon-shape icon-md bg-primary-subtle text-primary-emphasis rounded-circle">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-calendar-event">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <path d="M4 5m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"></path>
                            <path d="M16 3l0 4"></path>
                            <path d="M8 3l0 4"></path>
                        ...
                        <div class="flex-grow-1">
                          <h6 class="mb-1">Conference Room B</h6>
                          <p class="mb-1 text-secondary small">Team Meeting</p>
                          <small class="text-primary-emphasis">Jan 26, 9:00 AM - 10:30 AM</small>
                        </div>
                        <span class="badge bg-primary-subtle text-primary-emphasis">Tomorrow</span>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="d-flex gap-3 p-3 border rounded">
                        <div class="icon-shape icon-md bg-success-subtle text-success-emphasis rounded-circle">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-device-desktop">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <path d="M3 4a1 1 0 0 1 1 -1h16a1 1 0 0 1 1 1v12a1 1 0 0 1 -1 1h-16a1 1 0 0 1 -1 -1v-12z"></path>
                            <path d="M7 20h10"></path>
                            <path d="M9 16v4"></path>
                        ...
                        <div class="flex-grow-1">
                          <h6 class="mb-1">Computer Lab</h6>
                          <p class="mb-1 text-secondary small">Training Session</p>
                          <small class="text-success-emphasis">Jan 27, 1:00 PM - 5:00 PM</small>
                        </div>
                        <span class="badge bg-success-subtle text-success-emphasis">Jan 27</span>
                      </div>
                    </div>
                    
                    <!-- Upcoming Reservation 3 -->
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="d-flex gap-3 p-3 border rounded">
                        <div class="icon-shape icon-md bg-info-subtle text-info-emphasis rounded-circle">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-presentation">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <path d="M3 4l18 0"></path>
                            <path d="M4 4v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-10"></path>
                            <path d="M12 14l0 4"></path>
                        ...
                        <div class="flex-grow-1">
                          <h6 class="mb-1">Main Auditorium</h6>
                          <p class="mb-1 text-secondary small">Annual Conference</p>
                          <small class="text-info-emphasis">Jan 28, 8:00 AM - 6:00 PM</small>
                        </div>
                        <span class="badge bg-info-subtle text-info-emphasis">Jan 28</span>
                      </div>
                    </div>
                    
                    <!-- Upcoming Reservation 4 -->
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="d-flex gap-3 p-3 border rounded">
                        ...
                        <div class="flex-grow-1">
                          <h6 class="mb-1">Meeting Room C</h6>
                          <p class="mb-1 text-secondary small">Project Review</p>
                          <small class="text-warning-emphasis">Jan 29, 2:00 PM - 4:00 PM</small>
                        </div>
                        <span class="badge bg-warning-subtle text-warning-emphasis">Jan 29</span>
                      </div>
                    </div>
                    
                    <!-- Upcoming Reservation 5 -->
                    <div class="col-lg-4 col-md-6 col-12">
                      <div class="d-flex gap-3 p-3 border rounded">
                        <div class="icon-shape icon-md bg-secondary-subtle text-secondary-emphasis rounded-circle">
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-device-desktop">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <path d="M3 4a1 1 0 0 1 1 -1h16a1 1 0 0 1 1 1v12a1 1 0 0 1 -1 1h-16a1 1 0 0 1 -1 -1v-12z"></path>
                            <path d="M7 20h10"></path>
                        ...
                        <div class="flex-grow-1">
                          <h6 class="mb-1">Research Lab</h6>
                          <p class="mb-1 text-secondary small">Equipment Testing</p>
                          <small class="text-secondary-emphasis">Jan 30, 10:00 AM - 2:00 PM</small>
                        </div>
                        <span class="badge bg-secondary-subtle text-secondary-emphasis">Jan 30</span>
                      </div>
                    </div>
                  </div>
                </div>
